...
const PORTS = [
  ...
  },
  {
    ...
    country: "United Kingdom",
    type: "Origin",
    description: "Modern deep-water container terminal on the Thames. Key FCL departure point for West Africa.",
    coords: [0.4731, 51.5074],
    flag: "🇬🇧",
  },
  {
    id: "sheerness",
    ...
    country: "United Kingdom",
    type: "Origin",
    description: "RoRo port on the Isle of Sheppey, Kent. Regular vehicle sailings to West Africa.",
    coords: [0.7596, 51.4425],
    flag: "🇬🇧",
  },
  {
    id: "teesport",
    ...
    country: "United Kingdom",
    type: "Origin",
    description: "RoRo and container port in the North East. Serves vehicle exports to West Africa.",
    coords: [-1.1427, 54.5974],
    flag: "🇬🇧",
  },
  {
    id: "tema",
