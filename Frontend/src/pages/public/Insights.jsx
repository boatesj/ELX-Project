...
export default function Insights() {
  return (
    <>
      <Helmet>
        <title>Insights & Freight Guides | Ellcworth Express</title>
        <meta name="description" content="Freight guides, customs explainers and trade intelligence for UK exporters shipping to Ghana and West Africa. Coming soon from Ellcworth Express." />
        <link rel="canonical" href="https://www.ellcworth.com/insights" />
      </Helmet>
