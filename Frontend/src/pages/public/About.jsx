...
const About = () => {
  return (
    <div className="bg-[#EDECEC]">
      <Helmet>
        <title>About Ellcworth Express | UK to West Africa Freight Specialists</title>
        <meta
          name="description"
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="mx-auto max-w-4xl px-4 md:px-6 lg:px-8">
          ...
          <div className="prose prose-slate max-w-none text-gray-700 space-y-5 text-base md:text-lg leading-relaxed">
            <p>
              For over 12 years, Ellcworth Express has been the quiet infrastructure
              behind some of Ghana's most important graduation ceremonies. Every year,
              the University of Ghana, KNUST, UCC, UDS, UHA and others outsource the
              design and printing of their blank degree certificates to specialist
              printers in the UK.
            </p>
            <p>
              By the time we receive the call, graduation is typically 7 days away.
              The certificates must be collected from the printer, packaged
              tamper-proof, cleared through UK export and Ghana customs, and delivered
              to campus — on time, every time.
            </p>
            <p>
              In 12 years, we have never let a single institution down.
            </p>
            <p>
              No delays. No lost consignments. No excuses. Just a track record that
              speaks for itself — and a reason why Ghana's universities keep calling us
        ...
        <div className="mx-auto max-w-4xl px-4 md:px-6 lg:px-8">
          ...
          <div className="text-gray-700 space-y-5 text-base md:text-lg leading-relaxed">
            <p>
              ...
              through a trusted network of storage and handling facilities positioned
              close to the airports and freight ports we use most — including a
              confirmed facility in <strong>Grays, Essex</strong>, near Tilbury port.
            </p>
            <p>
              This model allows us to consolidate cargo close to its supply source,
              reducing handling time and keeping costs lean. When your goods are
              ready, we collect, consolidate and move — without unnecessary legs in
              the chain.
            </p>
          </div>
        </div>
      ...
      <section className="py-16 md:py-24 bg-[#EDECEC]">
        <div className="mx-auto max-w-4xl px-4 md:px-6 lg:px-8">
          ...
          <div className="text-gray-700 space-y-5 text-base md:text-lg leading-relaxed">
            <p>
              Our primary corridor is UK to Ghana — Tilbury, Sheerness and Southampton
              connecting to Tema port in Accra. Ghana accounts for the majority of
              our volume and is where our customs knowledge, agent relationships and
              on-the-ground network are deepest.
            </p>
            <p>
              We also move cargo to Nigeria, Kenya and other West and East African
              destinations. If you are shipping to a destination on the continent,
              speak to us — we will tell you honestly whether we can serve it well.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-4xl px-4 md:px-6 lg:px-8">
          ...
          <div className="flex flex-col md:flex-row gap-8 items-start">
            ...
            <div className="text-gray-700 space-y-4 text-base md:text-lg leading-relaxed">
              <p>
                Ellcworth Express was built on a simple belief: that businesses and
                institutions moving cargo between the UK and West Africa deserve a
                freight partner who understands both sides of the corridor — not just
                the logistics, but the stakes.
              </p>
              <p>
      ...
      <section className="py-16 md:py-20 bg-[#1A2930] text-white">
        <div className="mx-auto max-w-4xl px-4 md:px-6 lg:px-8 text-center">
          ...
          <p className="text-gray-300 mb-8 max-w-xl mx-auto">
            Whether you are shipping certificates, vehicles or anything in between —
