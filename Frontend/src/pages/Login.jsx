...
const Login = () => {
  ...
  return (
    <div className="bg-[#1A2930] text-white">
      {/* Main wrapper – respects navbar padding from RootLayout */}
        ...
        <div className="grid gap-10 md:grid-cols-2 items-center">
          ...
          <section className="w-full">
            <div className="w-full bg-white rounded-xl shadow-2xl px-7 py-8 md:px-8 md:py-10 text-[#1A2930]">
              ...
              {/* Remember + Forgot */}
              <div className="flex items-center justify-between mb-6 text-xs md:text-sm">
                <label className="flex items-center gap-2">
                  <input type="checkbox" className="accent-[#FFA500] h-4 w-4" />
                  <span>Remember me on this device</span>
                </label>
                <button className="text-[#FFA500] hover:text-[#ffb733] transition">
                  Forgot password?
                </button>
              </div>
              ...
              <p className="mt-4 text-[11px] md:text-xs text-gray-500 text-center leading-relaxed">
                By signing in you confirm that you are authorised to access this
                portal and agree to Ellcworth Express&apos; terms of use and
                privacy policy.
              </p>
            </div>
          </section>
