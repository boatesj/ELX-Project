        ...
        <div className="mx-auto max-w-4xl px-4 md:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-10 items-start">
            <div className="text-gray-700 space-y-5 text-base leading-relaxed">
              <p>RoRo (Roll-on/Roll-off) is the industry standard for shipping vehicles to Nigeria. Once you book, we issue a shipping note — you deliver your car, van, or SUV to the departure port yourself, typically Grimsby, Southampton, Tilbury, Teesside, or Sheerness. From there, the port team takes over: they drive it onto the vessel and off again at Lagos. No craning, no containerisation, no risk of strapping damage.</p>
            ...
            <div className="rounded-2xl border border-gray-200 bg-[#F9FAFB] px-6 py-6">
              ...
              <ul className="space-y-3">
                {["Original V5C logbook","Valid passport copy (ID page)","Proof of purchase / commercial invoice","Bill of Lading (once issued)","Form M (arranged via your Nigerian bank)","Vehicle clean inside and out","Fuel tank no more than ¼ full","Check personal-items policy for your vessel (varies by sailing)"].map((item) => (
