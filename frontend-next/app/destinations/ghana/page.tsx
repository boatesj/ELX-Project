...
export const metadata: Metadata = {
  ...
  description: "Container shipping, RoRo vehicle shipping and air freight from the UK to Ghana. Ship cars, vans and trucks from major UK RoRo ports to Tema Port from £750. ICUMS customs clearance end-to-end.",
