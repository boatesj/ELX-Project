...
const ICUMS_STEPS = [
  { step: "01", title: "Pre-Arrival Declaration", body: "Under ICUMS (Integrated Customs Management System), importers or their licensed agents must lodge a Pre-Arrival Assessment Reporting System (PAARS) declaration before the vessel reaches Tema. This triggers an advance risk assessment by Ghana Revenue Authority (GRA) officers — meaning clearance work begins before the ship berths." },
  { step: "02", title: "Customs Classification & Valuation", body: "GRA assigns each shipment an HS tariff code. Import duty is calculated on the CIF value (Cost + Insurance + Freight). Most used vehicles attract 20% import duty plus 12.5% VAT. New goods vary by category. Correct classification from the outset is critical — misclassification is the most common cause of delays and demurrage charges at Tema." },
  { step: "03", title: "Examination & Release", body: "ICUMS uses a traffic-light selectivity system: Green (documentary check only), Yellow (document examination), Red (full physical examination of cargo). Well-prepared shipments with accurate documentation typically clear on Green or Yellow. We coordinate directly with our Tema-based agents to manage any examination requests and accelerate release." },
  { step: "04", title: "Duty Payment & Gate Pass", body: "Once assessed, duty and levies are paid through the GRA e-payment portal. A Gate Pass is issued, authorising removal of the cargo from port. Ellcworth Express Ltd manages this step end-to-end — you receive confirmation when your shipment is cleared and ready for collection or onward delivery." },
];

const FAQS = [
  { q: "How long does shipping from the UK to Ghana take?", a: "By sea, expect 15–21 days from Felixstowe, Tilbury, or Southampton to Tema Port. Add 3–5 working days for ICUMS customs clearance. Air freight to Accra International Airport (ACC) takes 3–5 days door-to-door." },
  ...
  { q: "Do you collect the vehicle, or do I need to deliver it to the port for RoRo shipping?", a: "For RoRo, you deliver the vehicle to the departure port yourself — typically Grimsby, Southampton, Tilbury, Teesside, or Sheerness. Once you book, we issue a shipping note for you to bring on the day. From there, the port team takes over and drives the vehicle onto the vessel — you don't drive it on yourself. We handle all export documentation, port booking, and ICUMS customs clearance at the Ghana end." },
      ...
      <section className="relative w-full bg-[#1A2930] text-white py-24 md:py-32 overflow-hidden">
        ...
        <div className="relative mx-auto max-w-4xl px-4 md:px-6 lg:px-8">
          <div className="flex items-center gap-2 mb-4 text-sm text-slate-400">
            ...
            <span>/</span><span className="text-[#FFA500]">Ghana</span>
          </div>
          ...
          <p className="text-lg md:text-xl text-gray-300 max-w-2xl mb-8">
            Ellcworth Express Ltd moves cargo from the UK to Ghana every week — vehicles via RoRo from £750, containers from £1,500. Sea freight to Tema Port, air freight to Accra Airport, customs cleared end-to-end under Ghana&apos;s ICUMS system.
          </p>
      ...
      <section className="py-16 md:py-20 bg-[#EDECEC]">
        <div className="mx-auto max-w-4xl px-4 md:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-10 items-center">
            ...
            <InstantQuoteEstimate destination="ghana" />
          </div>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-4xl px-4 md:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-10 items-start">
            <div className="text-gray-700 space-y-5 text-base leading-relaxed">
              <p>RoRo (Roll-on/Roll-off) is the industry standard for shipping vehicles to Ghana. Once you book, we issue a shipping note — you deliver your car, van, or SUV to the departure port yourself, typically Grimsby, Southampton, Tilbury, Teesside, or Sheerness. From there, the port team takes over: they drive it onto the vessel and off again at Tema. No craning, no containerisation, no risk of strapping damage.</p>
      ...
      <section className="py-16 md:py-24 bg-[#EDECEC]">
        <div className="mx-auto max-w-4xl px-4 md:px-6 lg:px-8">
          ...
          <div className="mt-10 rounded-2xl border border-[#FFA500]/30 bg-white px-6 py-5">
            <p className="text-sm text-gray-700 leading-relaxed"><span className="font-semibold text-[#1A2930]">Ellcworth Express Ltd handles ICUMS clearance on your behalf.</span> We work with licensed customs agents at Tema Port, prepare and submit all required documentation, and manage any GRA examination requests. You are kept informed at every stage.</p>
          </div>
        </div>
      </section>
