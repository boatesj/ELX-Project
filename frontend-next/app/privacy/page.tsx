...
export const metadata: Metadata = {
  title: "Privacy Policy | Ellcworth Express Ltd",
  description: "Privacy policy for Ellcworth Express Ltd — how we collect, use and protect your personal data.",
  alternates: { canonical: "https://www.ellcworth.com/privacy" },
};
