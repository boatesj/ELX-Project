...
export const metadata: Metadata = {
  title: "Cookie Policy | Ellcworth Express Ltd",
  description: "Cookie policy for Ellcworth Express Ltd — what cookies we use and how to manage them.",
  alternates: { canonical: "https://www.ellcworth.com/cookies" },
};
