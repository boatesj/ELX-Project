...
const HeroSlider = () => {
  ...
  return (
    <section
      id="Header"
      className="relative w-full min-h-[85vh] md:min-h-[110vh] pt-[120px] md:pt-[160px] lg:pt-[180px] pb-10 overflow-hidden text-white scroll-mt-[120px] md:scroll-mt-[160px]"
      ...
      <div className="absolute inset-0">
        {slides.map((slide, index) => (
          ...
          >
            ...
            <div className="absolute inset-0 bg-gradient-to-b from-black/85 via-black/60 to-black/20 md:bg-gradient-to-r md:from-black/85 md:via-black/60 md:to-[#FFA500]/10" />
          </div>
        ))}
      </div>
          ...
          <div className="max-w-2xl space-y-5">
            ...
            <div className="mt-4 flex flex-wrap items-center gap-4">
              <a
                ...
                className="inline-flex items-center justify-center rounded-full border border-[#FFA500] bg-[#FFA500] px-6 py-2.5 text-sm font-semibold text-black shadow-md shadow-black/40 transition hover:bg-[#ffb733] focus:outline-none focus:ring-2 focus:ring-[#FFA500]/80 focus:ring-offset-2 focus:ring-offset-black/60"
              >
          ...
          <div className="mt-8 flex max-w-2xl flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div className="flex items-center gap-3">
              <button
                ...
                className="inline-flex h-9 w-9 items-center justify-center rounded-full border border-white/30 bg-black/40 text-[15px] font-semibold text-gray-100 backdrop-blur-sm transition hover:bg-black/70 hover:text-white focus:outline-none focus:ring-2 focus:ring-white/70"
