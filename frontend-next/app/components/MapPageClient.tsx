    ...
    <div className="bg-[#0B141A] min-h-screen">
      <section className="relative w-full bg-[#1A2930] text-white py-16 md:py-20 overflow-hidden">
        ...
        <div className="relative mx-auto max-w-4xl px-4 md:px-6 lg:px-8">
          ...
          <h1 className="text-3xl md:text-4xl font-semibold uppercase mb-4">Our port connections</h1>
          <p className="text-gray-300 max-w-xl text-base md:text-lg leading-relaxed">UK departure ports and West Africa destinations. Click any marker for details.</p>
      ...
      <section className="py-12 bg-[#1A2930]">
        <div className="mx-auto max-w-4xl px-4 md:px-6 lg:px-8 text-center">
          <h2 className="text-xl md:text-2xl font-semibold uppercase text-white mb-3">Shipping to one of these ports?</h2>
          <p className="text-gray-300 text-sm mb-6">Get a quote in 24 hours.</p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="mailto:cs@ellcworth.com" className="inline-flex items-center justify-center rounded-full bg-[#FFA500] text-black px-8 py-3 text-sm font-semibold tracking-[0.14em] uppercase hover:bg-[#ffb733] transition shadow-md">
              cs@ellcworth.com
            </a>
            <Link href="/#quote" className="inline-flex items-center justify-center rounded-full border border-white/30 bg-white/5 text-white px-8 py-3 text-sm font-semibold tracking-[0.14em] uppercase hover:bg-white/10 transition">
              Get a Quote
            </Link>
          </div>
        </div>
