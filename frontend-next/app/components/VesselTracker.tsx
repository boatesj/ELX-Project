    ...
    <section id="vessel-tracker" className="w-full py-14 md:py-20 bg-[#EDECEC] scroll-mt-[120px] md:scroll-mt-[160px]" aria-label="Live vessel tracking — UK to West Africa corridor">
      <div className="mx-auto max-w-6xl px-4 md:px-6 lg:px-8">
        <div className="mb-8 md:mb-10">
          ...
          <p className="text-sm md:text-base text-gray-600 max-w-2xl">Track vessels currently operating on the routes we work with. Sailings connect London Gateway, Tilbury, Sheerness, Teesport and Southampton to Tema, Lagos and beyond.</p>
        </div>
        ...
        <div className="rounded-2xl overflow-hidden border-2 border-[#1A2930] shadow-lg">
          <div className="bg-[#1A2930] px-4 py-3 flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs font-semibold tracking-[0.16em] uppercase text-white">Live — Powered by VesselFinder</span>
            </div>
            <button type="button" onClick={() => setView((v) => (v === "tema" ? "westAfrica" : "tema"))}
          ...
          <iframe key={view} src={VIEWS[view].src} title="Live vessel tracking — UK to West Africa" width="100%" height="400" loading="lazy" className="block w-full border-0" allowFullScreen />
        </div>
