        ...
        <div className="container mx-auto flex h-[72px] items-center justify-between px-4 md:px-8 lg:px-16">
          ...
          <div className="flex min-w-0 items-center gap-3">
            ...
            <div className="flex flex-col leading-tight">
              <span className="whitespace-nowrap text-sm font-bold tracking-[0.18em] text-white sm:text-base md:text-xl">
                ELLCWORTH <span className="text-[#FFA500]">EXPRESS</span>
              </span>
              <span className="mt-1 whitespace-nowrap text-[0.55rem] uppercase tracking-[0.25em] text-[#FFA500] sm:text-[0.6rem] md:text-[0.6rem]">
        ...
        <div className="container mx-auto flex h-[52px] items-center justify-between px-4 md:px-8 lg:px-16">
          <nav className="hidden flex-1 justify-center md:flex" aria-label="Main navigation">
            <ul className="flex items-center gap-7 text-xs font-medium capitalize tracking-[0.12em] text-[#1A2930] md:text-sm">
              <li><Link href="/" className="cursor-pointer hover:text-gray-800">Home</Link></li>
              <li><Link href="/#services" className="cursor-pointer hover:text-gray-800">Our Services</Link></li>
              <li><Link href="/#whyus" className="cursor-pointer hover:text-gray-800">Why Us</Link></li>
              <li><Link href="/#repackaging" className="cursor-pointer hover:text-gray-800">Repack &amp; Consolidation</Link></li>
              <li><Link href="/#booking" className="cursor-pointer hover:text-gray-800">Book a Shipment</Link></li>
              <li><Link href="/#testimonials" className="cursor-pointer hover:text-gray-800">Client Stories</Link></li>
            </ul>
          </nav>
