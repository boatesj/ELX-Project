...
const Shipment = () => {
  const { shipmentId } = useParams(); // 👈 grab the dynamic value from /shipment/:shipmentId
  ...
  return (
    <div className="m-[30px] bg-white p-[30px] rounded-md shadow-md">
      ...
      <p className="text-sm text-gray-500 mb-[20px]">
        Reference: <span className="font-mono">{shipmentId}</span>
      </p>
      ...
      <div className="flex gap-[40px] flex-wrap">
        ...
        <div className="flex flex-col ">
          <h2 className="font-semibold">Feedback/Comments</h2>
